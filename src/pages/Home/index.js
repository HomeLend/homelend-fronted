...
export default class Home extends Component {
  render() {
    return(
      <div style={{height: '100vh', minHeight: '1100px', display: 'grid', gridTemplateColumns: 'calc(33.33% - 10px) calc(33.33% - 10px) calc(33.33% - 10px)', gridTemplateRows: 'calc(33.33% - 10px) calc(33.33% - 10px) calc(33.33% - 10px)', gridGap: '15px', padding: '10px'}}>
